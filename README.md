...
!["Modelo lógico de banco de daodos"](modelo-casa-oliveira.png)
...
-- -----------------------------------------------------
-- Table `sakila`.`Produto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Produto` (
...
-- Table `sakila`.`Venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Venda` (
  ...
  CONSTRAINT `fk_Venda_Cliente1`
    ...
    REFERENCES `sakila`.`Cliente` (`idcliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sakila`.`itensVenda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`itensVenda` (
  ...
  CONSTRAINT `fk_itensVenda_Produto1`
    ...
    REFERENCES `sakila`.`Produto` (`idproduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_itensVenda_Venda1`
    FOREIGN KEY (`idvenda`)
    REFERENCES `sakila`.`Venda` (`idvenda`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sakila`.`Pagamento` (
  ...
  INDEX `fk_Pagamento_Venda1_idx` (`idvenda` ASC),
